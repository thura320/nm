...
''',reply_markup=keyboard)
		...
		sw = types.InlineKeyboardButton(text=f" Stripe Charge 1$ 🪽",callback_data='sq')
		sw1 = types.InlineKeyboardButton(text=f" Stripe Charge 2$ 🪽",callback_data='st')
		sw2 = types.InlineKeyboardButton(text=f"Stripe Charge 3$ 🪽",callback_data='au')
...
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "insufficient_funds" in last or 'successfully' in last or 'thank' in last or 'thank you for your payment' in last or 'thank you for your purchase' in last or 'thank you' in last or 'redirecturl' in last or 'redirect_to' in last:
						live += 1
...
𝙏𝙞𝙢𝙚 ➼ {"{:.1f}".format(execution_time)}
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "insufficient funds" in last or 'submitted' in last or 'Thank You For Your Support!' in last or 'Thank' in last or 'thank-you-for-your-support' in last or 'thank you' in last:
						live += 1
						bot.send_message(call.from_user.id, msg)
					elif 'risk' in last:
						risk+=1
...
𝙏𝙞𝙢𝙚 ➼ {"{:.1f}".format(execution_time)}
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "Your card has insufficient funds" in last or 'redirecturl' in last or 'redirect_url' in last or 'Thank You' in last or 'thank' in last or 'Thank you for your message' in last:
						live += 1
						bot.send_message(call.from_user.id, msg)
					elif 'risk' in last:
						risk+=1
